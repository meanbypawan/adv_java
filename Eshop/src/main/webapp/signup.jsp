...
<div class="container container-size d-flex justify-content-center align-items-center">
   <div class="form" style="width:30%;height:250px;box-shadow: 5px 5px 5px grey">
     <h6 class="bg-danger text-white text-center p-1">Sign up</h6>
     <form class="p-2" action="controller/signup_controller.jsp" method="post">
       ...
       <div class="form-group">
         <p class="text-center"><a href="signin.jsp">Already have account ?</a></p>
       </div>
     </form>
   </div>
</div>
